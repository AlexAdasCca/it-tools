...
<template>
  <div>
    <c-card>
      <c-input-text v-model:value="clearText" multiline raw-text :placeholder="$t('tools.hash-text.input.placeholder')" rows="3" autosize autofocus :label="$t('tools.hash-text.input.label')" />
      <n-divider />
